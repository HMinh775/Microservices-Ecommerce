...
export default function OrderDetailModal({ order, payment, onClose, onStatusChange, onDelete, onNavigateTracking }) {
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <button
              ...
              style={{
                padding: '12px 24px', borderRadius: 24, border: '1.5px solid #bfdbfe',
                background: '#eff6ff', cursor: 'pointer', fontWeight: 700, fontSize: 14, color: '#1d4ed8',
                transition: 'all 0.2s'
              }}
