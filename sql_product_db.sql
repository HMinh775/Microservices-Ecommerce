...
(11, 'Chân Váy Chữ A Kaki',          'Nem Fashion',  'Kaki cao cấp',      'Váy',         'Chân váy dài qua gối, thanh lịch dễ phối với áo blouse hay áo sơ mi.',    '1.jpg'),
(12, 'Đầm Maxi Linen Mùa Hè',       'Zara',         'Linen 100%',        'Váy',         'Đầm dài thoáng mát cho ngày hè, thiết kế tối giản tinh tế.',              '2.jpg'),
-- PHỤ KIỆN
(13, 'Túi Tote Canvas In Logo',      'adidas',       'Canvas 12oz',       'Phụ kiện',    'Túi tote cỡ lớn, chắc chắn, in logo nổi bật, đựng vừa laptop 15".',       '3.jpg'),
(14, 'Mũ Bucket Hat Reversible',     'New Era',      'Cotton twill',      'Phụ kiện',    'Mũ bucket 2 mặt, có thể mix phong cách khác nhau.',                       '4.jpg'),
(15, 'Thắt Lưng Da Bò Full Grain',   'Pedro',        'Da bò thật',        'Phụ kiện',    'Thắt lưng da thật cao cấp, bền bỉ theo năm tháng.',                       '5.jpg'),
-- THÊM 35 SẢN PHẨM MỚI
(16, 'Áo Sơ Mi Linen Trắng',         'Zara',         'Linen 100%',        'Áo',          'Sơ mi linen mát mẻ, thích hợp cho hè và những ngày trời nóng.',           '6.jpg'),
(17, 'Áo Thun Graphic Print',        'H&M',          'Cotton 100%',       'Áo',          'Áo thun in họa tiết thời trang, năng động và cá tính.',                  '7.jpg'),
(18, 'Áo Blazer Slim Fit',           'Zara',         'Vải Wool blend',    'Áo',          'Blazer lịch lãm, perfect cho công sở và dự tiệc.',                        '8.jpg'),
(19, 'Áo Cardigan Dệt Kim',          'Uniqlo',       'Acrylic 100%',      'Áo',          'Cardigan ấm áp, dễ phối, phù hợp mọi mùa.',                              '9.jpg'),
(20, 'Áo Sweater Cơ Bản',            'Lacoste',      'Cotton blend',      'Áo',          'Sweater cổ lọ ấm áp, màu sắc đa dạng.',                                  '10.jpg'),
(21, 'Áo Crop Top',                  'H&M',          'Cotton 100%',       'Áo',          'Crop top hiện đại, tôn dáng cho mùa hè.',                                '1.jpg'),
(22, 'Áo Tanktop Nam',               'Nike',         'Polyester blend',   'Áo',          'Tanktop thấm hút mồ hôi, lý tưởng cho tập luyện.',                       '2.jpg'),
(23, 'Quần Chinos Slim',             'Aristino',     'Cotton blend',      'Quần',        'Quần chinos dáng slim, dễ phối, không bị nhăn.',                         '3.jpg'),
(24, 'Quần Tây Công Sở',             'Hugo Boss',    'Wool blend',        'Quần',        'Quần tây cao cấp, bền bỉ và sang trọng.',                                '4.jpg'),
(25, 'Quần Denim Ripped',            'Topshop',      'Denim 100%',        'Quần',        'Quần jean ripped trend hiện nay, cá tính và năng động.',                 '5.jpg'),
(26, 'Quần Kaki Casual',             'Dockers',      'Cotton blend',      'Quần',        'Quần kaki thoải mái, phù hợp cho ngày thường.',                          '6.jpg'),
(27, 'Quần Palazzo Nữ',              'Zara',         'Rayon blend',       'Quần',        'Quần palazzo rộng rãi, nữ tính và thanh lịch.',                          '7.jpg'),
(28, 'Legging Co Giãn',              'Nike',         'Nylon blend',       'Quần',        'Legging thoáng mát, co giãn 4 chiều.',                                   '8.jpg'),
(29, 'Đầm Cocktail',                 'Zara',         'Polyester blend',   'Váy',         'Đầm ngắn thanh lịch, phù hợp cho các cuộc tiệc.',                        '9.jpg'),
(30, 'Váy Denim Ngắn',               'H&M',          'Denim 100%',        'Váy',         'Váy denim ngắn, kinh điển và dễ phối.',                                 '10.jpg'),
(31, 'Váy Midi Nữ Tính',             'IVY moda',     'Linen blend',       'Váy',         'Váy midi tôn dáng, vải mềm mại.',                                       '1.jpg'),
(32, 'Váy Xếp Ly Học Sinh',          'Local Brand',  'Polyester blend',   'Váy',         'Váy xếp ly trẻ trung, phong cách Hàn Quốc.',                             '2.jpg'),
(33, 'Túi Đeo Chéo',                 'Zara',         'Canvas',            'Phụ kiện',    'Túi đeo chéo tiện lợi, dung tích vừa chứa đồ cần thiết.',                 '3.jpg'),
(34, 'Túi Xách Tay',                 'Coach',        'Leather blend',     'Phụ kiện',    'Túi xách cao cấp, bảo hành 5 năm.',                                      '4.jpg'),
(35, 'Úp Lê Len Lừng',               'Uniqlo',       'Wool 100%',         'Phụ kiện',    'Úp lê ấm áp, tạo điểm nhấn cho outfit.',                                 '5.jpg'),
(36, 'Khăn Quàng Cổ',                'Burberry',     'Silk blend',        'Phụ kiện',    'Khăn quàng cao cấp, sang trọng và thanh lịch.',                          '6.jpg'),
(37, 'Mũ Nón Lưỡi Trai',             'Adidas',       'Cotton twill',      'Phụ kiện',    'Mũ nón thể thao, bảo vệ tốt từ tia UV.',                                 '7.jpg'),
(38, 'Giày Sneaker Nam',             'Nike',         'Mesh + Synthetic',  'Phụ kiện',    'Sneaker thoáng mát, phù hợp cho hoạt động hàng ngày.',                   '8.jpg'),
(39, 'Giày Oxford Công Sở',          'Clarks',       'Leather',           'Phụ kiện',    'Giày oxford chính hãng, thoải mái suốt cả ngày.',                        '9.jpg'),
(40, 'Sandal Da Thun',               'Birkenstock',  'Leather + Cork',    'Phụ kiện',    'Sandal da Đức, lâu bền và thoải mái.',                                  '10.jpg'),
(41, 'Áo Khoác Gió Lightweight',     'Columbia',     'Polyester',         'Áo',          'Khoác gió nhẹ, dễ gấp gọn, phù hợp phượt.',                              '1.jpg'),
(42, 'Áo Denim Jacket',              'Levi\'s',      'Denim 100%',        'Áo',          'Áo denim cổ điển, bền bỉ theo năm tháng.',                               '2.jpg'),
(43, 'Áo Overcoat Dài',              'Zara',         'Wool blend',        'Áo',          'Overcoat dài sang trọng, phù hợp cho mùa lạnh.',                        '3.jpg'),
(44, 'Áo Gilet Phông',               'H&M',          'Nylon',             'Áo',          'Gilet phông ấm áp, nhẹ nhàng không bí bách.',                            '4.jpg'),
(45, 'Quần Tây Công Sở Premium',     'Armani',       'Wool 100%',         'Quần',        'Quần tây cao cấp, may tuyệt vời, bền lâu.',                              '5.jpg'),
(46, 'Quần Jogger Cotton',           'Adidas',       'Cotton blend',      'Quần',        'Quần jogger thoệ dễ chịu, phù hợp cho nhà.',                             '6.jpg'),
(47, 'Quần Short Jean Nữ',           'Topshop',      'Denim 100%',        'Quần',        'Quần short denim, kinh điển và dễ phối.',                               '7.jpg'),
(48, 'Váy Trễ Vai Nữ Tính',          'Zara',         'Cotton blend',      'Váy',         'Váy trễ vai nhẹ nhàng, phù hợp cho hẹn hò.',                             '8.jpg'),
(49, 'Váy Công Chúa Tulle',          'Local Brand',  'Tulle + Lining',    'Váy',         'Váy công chúa sang trọng, lý tưởng cho tiệc cưới.',                     '9.jpg'),
(50, 'Đầm Bodycon Bó Sát',           'ASOS',         'Elastane blend',    'Váy',         'Đầm bó sát tôn dáng, hoàn hảo cho những dạo chơi ban đêm.',              '10.jpg');
